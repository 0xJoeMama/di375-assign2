...
Η υλοποίησή τους είναι σχετικά εύκολη και μπορεί να γίνει με αντιγραφή του κώδικα που δίνει τιμές στα σήματα \mintinline{vhdl}{shifted_a} και \mintinline{vhdl}{rotated_a} στην την dataflow αρχιτεκτονική από την dataflow αρχιτεκτονική.
